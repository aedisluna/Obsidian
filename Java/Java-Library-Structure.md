# Библиотека шпаргалок по Java
*Структурированный гид по изучению Java, разработке и тестированию*
...
### 🔹 Основы Java
- [[Java-Basics|Основы языка]] - типы данных, переменные, операторы
- [[OOP-Principles|Принципы ООП]] - инкапсуляция, наследование, полиморфизм, абстракция
...
### 🔹 Тестирование
- [[JUnit-Basics|Основы JUnit]] - модульное тестирование
- [[Test-Annotations|Аннотации для тестов]]
- [[Mocking|Мокирование]] - Mockito
...
#java #основы #oop #collections #testing #advanced #strings #exceptions #regex #streams #lambdas #junit #patterns
...
### Для новичков
1. [[Java-Basics|Основы Java]]
2. [[String|Работа со строками]]
3. [[Arrays|Массивы]]
4. [[OOP-Principles|ООП принципы]]
